...
class CacheStore:
    ...
    def compute_key(
        ...
        *,
        ...
        # archive / diagnosticsの表現（aggregated messages + hint-urls）切替時に
        # v2に更新した。textlint向けのErrorLocation.hint追加に合わせてv3に更新した。
        # summary.commands_summary階層化・hint_urlsリネーム・textlint end_line/end_col追加でv4に更新した。
